...
cc.Class({
    ...
    properties: {
        m_InnerScrollViews: [require("NtScrollViewIn")], //挂内嵌的ScrollView
    ...
    onLoad: function() {
        // this.m_PlanDir = null;
        // let nameArray = [
        //     'Canvas/ScrollViewA/view/content/ScrollViewB',
        //     'Canvas/ScrollViewA/view/content/ScrollViewC'
        // ];

        // console.log("this.node.name = " + this.node.name);
        // for (let index = 0; index < nameArray.length; index++) {
        //     let node = cc.find(nameArray[index]);
        //     // var node = this.node.getChildByName(nameArray[index]);
        //     if (node) {
        //         let com = node.getComponent('NestableScrollView_Inner');
        //         this.m_InnerScrollViews.push(com);
        //         console.log("find " + nameArray[index]);
        //     } else {
        //         console.log("can not find " + nameArray[index]);
        //     }
        // }
